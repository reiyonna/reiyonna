...
### Analytics
![Amplitude](https://img.shields.io/badge/Amplitude-1B5BFF?style=flat&logoColor=white)
...
- **Recommendation systems** — personalisation pipelines using collaborative filtering and content-based models for a data analytics social platform
- **Computer vision** — object detection, segmentation and tracking using YOLO, Detectron2 and Mask R-CNN *(national hackathon winner)*
- **SaaS platforms** — B2B and B2C multi-tenant systems with event-driven pipelines, GraphQL APIs and Auth0 SSO
- **NLP** — transformer-based pipelines for entity extraction, text classification and semantic similarity
